from backend.repositories import SignOrderRepository

class SignService():

    signs = SignOrderRepository()
    ...
    def recent_quotes(self, items=10, offset=0, all=False):
        ...
        return self.signs.filter(filter_criteria, all, items, offset)
